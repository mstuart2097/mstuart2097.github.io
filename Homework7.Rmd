...
1. For each of the following studies/experiments, determine what the numerator and denominator for performing an F test for differences in the group means will be.  In other words, what are the degrees of freedom for the model and for the error?
