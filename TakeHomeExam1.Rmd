...
g. [5 pts] Perform a hypothesis test for a linear relationship between yard differential and point differential.  Be sure to formally state all the necessary information to perform a formal hypothesis test.  Assume $\alpha = 0.05$.
```{r}
```
